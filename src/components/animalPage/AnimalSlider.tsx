...
const AnimalSlider: React.FC<Props> = ({ photos }) => {
    const slides = [
        {
    ...
    return (
        photos && (
            <div className=" bg-red-300 w-full h-[628px] rounded-b-2xl m-auto mb-5 py-16 px-4 relative group">
                <div
                    ...
                    {photos.map((slide, slideIndex) => (
                        <div
                            ...
                            {slideIndex === currentIndex ? (
                                <RxDotFilled fill="white" stroke="white" />
                            ) : (
                                <RxDot fill="white" stroke="white" />
                            )}
                        </div>
                    ))}
                </div>
