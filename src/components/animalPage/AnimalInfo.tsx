...
const AnimalInfo: React.FC<Props> = ({ singleAnimal }) => {
    const { name, breed, location, photos, ...rest } = singleAnimal;

    console.log(singleAnimal);

    return (
        <div className=" max-w-[1200px] overflow-hidden bg-white shadow-lg ring-1 ring-black ring-opacity-5 sm:rounded-lg">
