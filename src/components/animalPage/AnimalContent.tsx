...
const AnimalContent: React.FC<Props> = ({ animalId }) => {
  ...
  const { getPets, status, setStatus, _tranformToPetInformation } =
    PetsFetching();
...
const LoadingSinglePet: React.FC = () => {
  return (
    <div className=" py-9 px-3 flex justify-center gap-4 lg:flex-nowrap flex-wrap">
      <div
        role="status"
        className=" w-[900px] h-[599px] p-4 border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700"
      >
