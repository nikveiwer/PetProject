...
const SavedSearches: React.FC = () => {
    const { savedSearches, deleteSearch, visibleSearches } = useSavedSearchesStore();
                    ...
                    return (
                        <li
                            ...
                            <div className="w-[20%] border-r-[1px] border-gray-700 flex flex-col justify-center text-center">
                                <button
                                    className="text-lg uppercase text-red-300 cursor-pointer"
                                    onClick={() => onSearchLaunch(item)}>
                                    <Link href={`availablePets/${item.type}`}>Launch search</Link>
                                </button>
                            </div>
